...
import {
    ...
    CForm, CFormLabel, CFormInput, CRow, CCol
} from '@coreui/react';
...
const SlidingDoorManagement = () => {
    ...
    const slidingDoorSubcategories = [
        {
            image: image1,
            productName: "Classic Sliding Glass Door",
            description: "A simple yet elegant sliding glass door with smooth operation, ideal for living rooms.",
            price: "$350.00",
        ...
        {
            image: image2,
            productName: "Rustic Wood Sliding Door",
            description: "A rustic, wooden sliding door perfect for farmhouse or rustic interior designs.",
            price: "$400.00",
            category: "Sliding Doors",
        ...
        {
            image: image3,
            productName: "Modern Steel Sliding Door",
            description: "A sleek steel door with a modern design, perfect for industrial-themed homes.",
            price: "$500.00",
            category: "Sliding Doors",
        ...
        {
            image: image4,
            productName: "Barn Style Sliding Door",
            description: "A charming barn-style sliding door, adding a touch of country charm to any room.",
            price: "$600.00",
            category: "Sliding Doors",
            subcategory: "Barn Doors"
        }
    ];
    ...
    return (
        <>
            ...
            <CCard>
                ...
                <CCardBody>
                    ...
                    <CTable striped bordered hover responsive>
                        ...
                        <CTableBody>
                            {slidingDoorSubcategories.map((subcategory, index) => (
                                <CTableRow key={index}>
            ...
            {/* Add Sliding Door Modal */}
            <CModal size='md' visible={visible} onClose={() => setVisible(false)}>
                <CModalHeader>
                    <CModalTitle>Add New Sliding Door</CModalTitle>
                </CModalHeader>
                <CModalBody>
                    <CForm>
                        <CRow>
