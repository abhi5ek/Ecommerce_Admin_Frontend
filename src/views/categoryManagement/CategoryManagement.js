...
const CategoryManagement = () => {
    ...
    const handleSaveCategory = async () => {
        ...
        try {
            const response = await axios.post('http://18.209.197.35:5000/api/category/addcategory', {
    ...
    const handleSaveSubCategory = async () => {
        ...
        try {
            const response = await axios.post('http://18.209.197.35:5000/api/category/addsubcategory', {
    ...
    const handleSaveSubSubCategory = async () => {
        ...
        try {
            const response = await axios.post('http://18.209.197.35:5000/api/category/addsubsubcategory', {
                categoryName: newCategory,
                subcategoryName: newSubcategory,
    ...
    //     if (confirmation) {
    //         try {
    //             await axios.delete(`http://18.209.197.35:5000/api/category/delete-category/${category._id}`);
    //             fetchData();
    //         } catch (error) {
    //             console.error(error);
    //         }
    ...
    const handleDeleteSubcategory = async (categoryName, subcategory) => {
        ...
        if (confirmation) {
            try {
                await axios.delete(`http://18.209.197.35:5000/api/category/delete-subcategory/${categoryName}/${subcategory._id}`);
                fetchData();
            } catch (error) {
                console.error(error);
            }
    ...
    const handleDeleteSubSubCategory = async (categoryName, subcategoryName, subSubcategory) => {
        ...
        if (confirmation) {
            try {
                await axios.delete(`http://18.209.197.35:5000/api/category/delete-subsubcategory/${categoryName}/${subcategoryName}/${subSubcategory._id}`);
                fetchData();
            } catch (error) {
                console.error(error);
            }
