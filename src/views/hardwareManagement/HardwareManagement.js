                        ...
                        <CRow className="align-items-center">
                            ...
                            <CCol xs={12} md={6}>
                                <div className="text-md-left" style={{ textAlign: 'left' }}>
                                    ...
                                    <p><strong>Product Name:</strong> {hardwareProduct.productDetails.productName || "N/A"}</p>
                                    <p><strong>Catgory Name:</strong> {hardwareProduct.productDetails.categoryName || "N/A"}</p>
                                    <p><strong>Sub-Category Name:</strong> {hardwareProduct.productDetails.subCategory || "N/A"}</p>
                                    <p><strong>Sub Sub-Category Name:</strong> {hardwareProduct.productDetails.subSubCategory || "N/A"}</p>
                                    <p><strong>Description:</strong> {hardwareProduct.productDetails.description || "N/A"}</p>
                                    <p><strong>Price:</strong> ${hardwareProduct.productDetails.price || "N/A"}</p>
                                </div>
                            </CCol>
                        </CRow>
                    )}
