...
const EntryDoorsManagement = () => {
    ...
    const fetchData = async () => {
        const response = await axios.get(`http://18.209.197.35:5000/api/biFoldDoors/`);
    ...
    const handleViewClick = async (id) => {
        try {
            const response = await axios.get(`http://18.209.197.35:5000/api/biFoldDoors/getbyid/${id}`);
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await axios.post("http://18.209.197.35:5000/api/biFoldDoors/create/", data, {
    ...
    const handleDelete = async (id) => {
        ...
        if (isConfirmed) {
            try {
                await axios.delete(`http://18.209.197.35:5000/api/biFoldDoors/delete/${id}`);
    ...
    const handleUpdate = async () => {
        ...
        try {
            await axios.put(`http://18.209.197.35:5000/api/biFoldDoors/update/${selectedProduct._id}`, data, {
                headers: { "Content-Type": "multipart/form-data" },
            });
    ...
    const [dimensions, setDimensions] = useState({
        frameWidthAndHeight: { label: "Frame Width X Height", data: [] },
        gridOption: { label: "Choose Grid Option", data: [] },
        frameExtrusion: { label: "Choose Frame Extrusion", data: [] },
        color: { label: "Color", data: [] },
        selectGlassforDoor: { label: "Select Glass for Door", data: [] },
        selecttheFrameSize: { label: "Select the Frame Size", data: [] },
        doorSwingDirection: { label: "Select Door Swing Direction", data: [] },
        selectPrefinishing: { label: "Select Prefinishing Options-6/8", data: [] },
    ...
    const handleDimensionSubmit = async (e) => {
        ...
        try {
            const response = await axios.put(
                `http://18.209.197.35:5000/api/biFoldDoors/add-dimensions/${dimensionId}`,
            ...
            <CCard>
                <CCardHeader>
                    <div className="d-flex justify-content-between align-items-center">
                        <h5>Multiple Slide & BiFold Doors Management</h5>
